...
if (isset($_POST["submit"])) {
    ...
    if ($result) {
        echo "<script type='text/javascript'>
                ...
                document.location.href = 'list_segitiga.php';
            </script>";
    }else{
        echo "<script type='text/javascript'>
...
<div class="container">
    ...
    <form action="" method="post" onsubmit="return cekform()">
        <div class="mb-3">
            <label class="form-label">Alas:</label>
            <input type="number" name="nm_anggota" id="nm_anggota" class="form-control" placeholder="Masukkan Alas" required />

        </div>
        <div class="mb-3">
            <label class="form-label">Tinggi:</label>
            <input type="number" name="nik_anggota" id="nik_anggota" class="form-control" placeholder="Masukkan Tinggi" required/>
